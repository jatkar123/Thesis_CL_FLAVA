...
def classify_image_by_url(url, model_name):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name", default="Select between FLAVA and CLIP"
    )
    ...
    for index, url in enumerate(
        ...
        print(f"\n\n===================== IMAGE {index+1} =====================")
        classify_image_by_url(url, model_name= args.model_name)
